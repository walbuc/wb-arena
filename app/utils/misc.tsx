...
import type {User, NonNullProperties} from '~/types'
...
/**
 * @returns domain URL (without a ending slash, like: https://wbarena.com)
 */
...
function getUrl(requestInfo?: {origin: string; path: string}) {
  return removeTrailingSlash(
    `${requestInfo?.origin ?? 'https://wbarena.com'}${requestInfo?.path ?? ''}`,
  )
}
